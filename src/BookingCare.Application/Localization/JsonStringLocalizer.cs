...
namespace BookingCare.Application.Localization
{
    public class JsonStringLocalizer : IStringLocalizer
    {
        ...
        public IEnumerable<LocalizedString> GetAllStrings(bool includeParentCultures)
        {
            ...
            string filePath = $"../BookingCare.Application/Resources/{Thread.CurrentThread.CurrentCulture.Name}.json";
        ...
        private string GetLocalizedString(string key)
        {
            ...
            string relativeFilePath = $"../BookingCare.Application/Resources/{Thread.CurrentThread.CurrentCulture.Name}.json";
